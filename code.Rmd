...
R is an odd programming language. While most beginners often think of it as a fancy statistical calculator, it is both a powerful and flexible language. For example, many new R users learn how to write and use (user-defined) functions quite quickly, without having to know [these details](https://kevinushey.github.io/blog/2015/11/22/what-is-a-function/).
